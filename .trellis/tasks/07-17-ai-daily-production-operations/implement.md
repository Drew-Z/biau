...
- Rollback evidence is now a separate low-sensitive sealed manifest. Acceptance v2 binds its evidence id/hash and the same acceptance/edition/issue/run tuple; no local check claims that Render or Cloudflare actions happened, and missing real evidence remains a human gate.
