...
- 语言范围已获用户决定：分阶段补齐中英文，先公共界面再内容。第 11 轮 `a8142559` 已交付共享偏好、导航辅助标签、页脚、载入与 404；第 12 轮 `d215071e` 已交付目录公共控件和移动分页；第 13 轮 `87b2e01c` 已交付详情公共阅读界面与共享目录，最终完整 UI 46/0、语言专项 12+24+12+5+1+24+4+2、smoke 21/0 通过。下一轮评估项目共享 publication 界面；首页、状态、AI Daily、助手及 authored 内容随后推进，不宣称全站已经双语。
