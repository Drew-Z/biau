...
- 语言范围已获用户决定：分阶段补齐中英文，先公共界面再内容。第 11 轮 `a8142559` 已交付共享偏好、导航辅助标签、页脚、载入与 404；第 12 轮 `d215071e` 已交付目录公共控件和移动分页，最终完整 UI 46/0、语言专项 12+24+12+5+1 和 smoke 21/0 通过。下一轮评估详情公共阅读界面；首页、状态、AI Daily、助手、共享 publication 文案及 authored 内容随后推进，不宣称全站已经双语。
