...
- 语言范围已获用户决定：分阶段补齐中英文，先公共界面再内容。第 11 轮 `a8142559` 已交付共享偏好、导航辅助标签、页脚、载入与 404；完整 UI 46/0、语言专项 12+5+1 和 smoke 21/0 通过。下一轮处理目录公共控件，详情/状态/AI Daily/助手及 authored 内容随后推进；不宣称全站已经双语。
