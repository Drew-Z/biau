...
- [ ] 保存最终验收/阻塞、资源与源码核对，按实际结果交付并回到父任务；只在全部 AC 满足后归档 CI。
...
- [ ] 按真实结果完成本地资料交付、父任务重新评估与 journal；CI 全部 AC 未满足时不归档。
...
- [x] 工作资料以 f6fb8fed 精确本地提交；仅本子任务归档，逐文件核对移动保真，并实际返回父任务确认 26/26 completed。journal 随后单独记录。
