...
- [ ] 确认当前 Pet 工作区是否存在 release APK/AAB 候选。
- [ ] 若没有 release 候选，主站和展示页继续不暴露下载 href。
- [ ] 若有 release 候选，记录签名、校验、版本和回归证据后再开放下载。
- [ ] `pet-showcase:synthetic` 或等效检查保证未批准前不会出现真实 APK 下载链接。
- [ ] 主站 Pet 项目详情、状态页和展示页下载状态一致。
