...
- Image fixtures validate MIME/Base64/signature/size boundaries, digest-only hashing, Responses `input_image`, prompt-injection isolation, cancellation, timeout, and LangGraph success/failure paths without a live provider call.
