...
| [State Management](./state-management.md) | Local/route state, persistent preferences, interface projections, assistant image/Branch/history ownership, static data | Filled |
| [Quality Guidelines](./quality-guidelines.md) | Lint/build gates, UI rules, image lifecycle and Branch/history send fixtures, public data safety | Filled |
