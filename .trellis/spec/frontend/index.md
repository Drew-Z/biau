...
| [State Management](./state-management.md) | Local/route state, persistent preferences, interface projections, assistant registry/image/Branch/history ownership, static data | Filled |
| [Quality Guidelines](./quality-guidelines.md) | Lint/build gates, UI rules, image/Branch/history fixtures and restore recovery, public data safety | Filled |
