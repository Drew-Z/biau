...
| [Component Guidelines](./component-guidelines.md) | Component shape, Lucide icons, props, styling, accessibility, homepage text/category roles, native reading links and responsive carousel motion | Filled |
...
| [Quality Guidelines](./quality-guidelines.md) | Lint/build gates, typography/contrast sampling, UI rules, native reading documents, carousel wheel and mode transitions, image/Branch/history/feedback fixtures and restore recovery, public data safety | Filled |
