...
title: "BIAU Port 项目总结：React 主站如何承接项目案例和博客治理"
...
# BIAU Port 项目总结：React 主站如何承接项目案例和博客治理
...
## Safe Public Facts
- BIAU Port 是 React、Vite、TypeScript、自定义设计系统和 Lucide 图标构建的产品/解决方案展示主站。
...
- Knowledge points: React 主站、自定义设计系统、项目案例数据、博客栏目、公开策展、AI 助手知识索引
