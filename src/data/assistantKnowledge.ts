...
export const ASSISTANT_SEARCH_ALIASES: AssistantSearchAliasGroup[] = [
  ...
  {
    triggers: ['状态', '状态页', '可靠性', '健康检查', '外链', '人工 gate', '人工队列', '手动处理', '下一步', '先做什么', '醒来', '明早', '复核', '刷新 RAG 状态', '公开助手模型配置', '后续接入', '低敏证据'],
    terms: ['项目可靠性观察', '状态页', 'health', 'synthetic', '公开入口', '监控', '人工 gate', '人工队列', '刷新 RAG 状态', '公开助手模型配置', '后续接入', '低敏证据'],
  },
  {
...
const INTENT_TERMS: Record<AssistantRetrievalIntent, string[]> = {
  ...
  'reliability-status': ['状态', '可靠性', '健康检查', '监控', '外链', '是否正常', '可用性', '人工 gate', '人工队列', '手动', '手动处理', '下一步', '先做什么', '醒来', '明早', '复核', '刷新 RAG 状态', '公开助手模型配置', '后续接入', '低敏证据'],
