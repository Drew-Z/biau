...
export const projects: Project[] = [
  ...
  },
  {
      ...
      workflow: [
        ...
        },
        {
          ...
          items: [
            ...
            '生产自助注册仍由服务端策略控制；未开放注册时页面会显示受控入口说明，引导用户使用已有账号、联系 Owner 分配账号或回到 BIAU Port 项目说明。',
        ...
        },
        {
          ...
          items: [
            ...
            'Owner 视角强调店铺凭据、插件发布和关键配置；协作者视角强调使用已配置好的同步、上架记录和工具流程。',
    ...
    assistantContext: [
      ...
      '认证入口已经补充确认密码校验、Owner 初始化提示、受控登录状态、注册关闭提示、主站返回桥接和 bootstrap 失败时不默认开放自助注册的前端兜底；生产自助注册仍由服务端策略控制，不在前端默认开启。',
      'ERP 概览页已经补充登录后首次引导，展示当前账号/角色、Owner 与协作者职责说明，并提供店铺配置、插件下载、商品同步和上架记录的推荐路径。',
