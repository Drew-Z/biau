...
const evalCases: EvalCase[] = [
  ...
  },
  {
    ...
    expectedIntent: 'reliability-status',
    requiredCitationIds: ['site:status'],
    requiredAnswerIncludes: ['BIAU Operator', 'Studio', 'Legal RAG', 'token', '模型渠道'],
    minCitationCount: 1,
    description: '人工队列问题应引用状态页，并优先说明 BIAU Operator、Studio 和受控 demo/release gate。',
  },
  {
    id: 'blog-knowledge',
  ...
  {
    id: 'resource-sharing-empty-state',
    question: '资源分享栏目为什么现在没有文章？之后怎么发布？',
    expectedIntent: 'blog-knowledge',
    requiredCitationIds: ['site:resources'],
    requiredAnswerIncludes: ['资源分享', '人工精选', 'Studio 草稿', '人工审核', 'Publish Export'],
    minCitationCount: 1,
    description: '资源分享空栏目问题应引用资源分享发布状态，而不是误导到 AI Daily。',
  },
  {
    id: 'resource-sharing-column-location',
    question: '博客里的资源分享在哪里看？',
    expectedIntent: 'blog-knowledge',
    requiredCitationIds: ['site:resources'],
    requiredAnswerIncludes: ['资源分享', '公开列表', '文章'],
    minCitationCount: 1,
    description: '资源分享栏目位置问题应引用资源分享发布状态。',
  },
  {
    id: 'resource-sharing-no-auto-link-list',
    question: '资源分享会自动生成链接清单吗？',
    expectedIntent: 'blog-knowledge',
    requiredCitationIds: ['site:resources'],
    requiredAnswerIncludes: ['不会自动', '链接清单', '使用边界', '公开来源'],
    minCitationCount: 1,
    description: '资源分享自动化边界问题应说明不会生成无筛选链接清单。',
  },
  {
